...
namespace ControllerTest {
    public static class Data {
        ...
        private static void setupCompetition() {
            ...
            Competition.Tracks.Enqueue(new Track("First", new SectionTypes[] { SectionTypes.StartGrid, SectionTypes.StartGrid, SectionTypes.StartGrid, SectionTypes.Finish, SectionTypes.RightCorner, SectionTypes.RightCorner, SectionTypes.Straight, SectionTypes.Straight, SectionTypes.Straight, SectionTypes.Straight, SectionTypes.RightCorner, SectionTypes.RightCorner }));
